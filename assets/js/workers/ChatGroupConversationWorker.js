...
onmessage = async (e) =>
{
    ...
    {
        // send message
        const sendURL = `${API_END_POINT}Chats/Conversations/Group/store`
        ...
        const ChatObject = {
            ...
            group_id: CHAT.receiver.id,
            group_name: CHAT.receiver.name,
    ...
    function search()
    {
        const searchURL = `${API_END_POINT}Chats/Conversations/Group/search`
        const SearchObject = {
            query: '',
            advanced: {
                sender_id: USER_CONFIG.employee_id,
